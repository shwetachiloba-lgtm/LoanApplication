...
<body>
  ...
  <main class="login-container">
        ...
        <form id="loginForm" action="CheckCustData" method="post" novalidate>
            <!-- Email Field -->
            <div class="form-group">
                <div class="password-wrapper">
                    <input type="email" id="email" name="cemail" class="input-control" placeholder=" " required>
            ...
            <div class="form-group">
                <div class="password-wrapper">
                    <input type="password" id="password" name="cpass" class="input-control" placeholder=" " required>
