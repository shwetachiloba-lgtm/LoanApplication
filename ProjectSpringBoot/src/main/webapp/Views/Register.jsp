...
<head>
    <meta charset="UTF-8">
    <title>User Registration - MyBank</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand fw-bold" href="index.jsp">Register Here</a>
    ...
    <div class="register-container">
        ...
        <form action="SaveCustomerData" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" id="confirmPassword" name="ccpass" required>
            </div>
